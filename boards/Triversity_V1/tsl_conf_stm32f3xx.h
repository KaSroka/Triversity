...
*/
#define TSLPRM_TKEY_DETECT_OUT_TH (30)
...
/** Linear/Rotary Detect state input threshold (range=0..255)
  - Enter Detect state if delta is above
*/
#define TSLPRM_LINROT_DETECT_IN_TH (45)
...
/** Direction change debounce (range=0..63)
  ...
  - A High value will result in a slower direction change.
*/
#define TSLPRM_LINROT_DIR_CHG_DEB (3)
...
//                                   STM32F30X STM32F37X
#define TSLPRM_TSC_GROUP1_IO1 CHANNEL  // PA0       PA0
#define TSLPRM_TSC_GROUP1_IO2 NU       // PA1       PA1
#define TSLPRM_TSC_GROUP1_IO3 SAMPCAP  // PA2       PA2
#define TSLPRM_TSC_GROUP1_IO4 NU       // PA3       PA3

#define TSLPRM_TSC_GROUP2_IO1 NU       // PA4       PA4
#define TSLPRM_TSC_GROUP2_IO2 CHANNEL  // PA5       PA5
#define TSLPRM_TSC_GROUP2_IO3 NU       // PA6       PA6
#define TSLPRM_TSC_GROUP2_IO4 SAMPCAP  // PA7       PA7

#define TSLPRM_TSC_GROUP3_IO1 CHANNEL  // PC5       PC4   << diff
#define TSLPRM_TSC_GROUP3_IO2 CHANNEL  // PB0       PC5   << diff
#define TSLPRM_TSC_GROUP3_IO3 NU       // PB1       PB0   << diff
#define TSLPRM_TSC_GROUP3_IO4 SAMPCAP  // PB2       PB1   << diff

#define TSLPRM_TSC_GROUP4_IO1 SHIELD   // PA9       PA9
#define TSLPRM_TSC_GROUP4_IO2 SAMPCAP  // PA10      PA10
...
#define TSLPRM_TSC_GROUP6_IO1 CHANNEL  // PB11      PB14  << diff
#define TSLPRM_TSC_GROUP6_IO2 NU       // PB12      PB15  << diff
#define TSLPRM_TSC_GROUP6_IO3 SAMPCAP  // PB13      PD8   << diff
